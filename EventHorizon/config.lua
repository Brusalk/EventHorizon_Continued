...
c.timer = {true,Priest and 0.7 or 1,0.3}  -- Timer bars. Default = {true,Priest and 0.7 or 1,0.3} (class colored, dimmed a bit if you're a Priest, 0.3 unmodified alpha)
