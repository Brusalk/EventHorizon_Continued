...
endlocal usemouseover = true	-- Make this false or nil (or just delete the line altogether) to make your healing bars not change when you mouse over something.


function EventHorizon:InitializeClass()
	self.config.gcdSpellID = 8042 -- Earth Shock
	self.config.hastedSpellID = {2008,10} -- Ancestral Spirit
